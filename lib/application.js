            ...
            _.each(_.keys(json), function (key) {
                ...
                if (str != null && str.name != null && str.comment != null) {
                    ...
                    if (comment.shortText != null) {
                        ...
                        var type = '';
                        var constrainedValues = _this.generateConstrainedValues(str);
                        var miscAttributes = _this.generateMiscAttributes(str);
                        if (str.type && str.type.name) {
                            type = str.type.name;
                        }
                        var notSupportedInValues = str.notSupportedIn ? str.notSupportedIn : '';
