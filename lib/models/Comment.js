var CommentTag_1 = require("./CommentTag");
var Comment = (function () {
    ...
    Comment.prototype.copyFrom = function (comment) {
        ...
        this.tags = comment.tags ? comment.tags.map(function (tag) { return new CommentTag_1.CommentTag(tag.tagName, tag.paramName, tag.text); }) : null;
    };
