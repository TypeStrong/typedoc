var ProjectReflection_1 = require("./reflections/ProjectReflection");
var REFLECTION_ID = 0;
...
var Reflection = (function () {
    ...
    Reflection.prototype.getFullName = function (separator) {
        ...
        if (this.parent && !(this.parent instanceof ProjectReflection_1.ProjectReflection)) {
    ...
    Reflection.prototype.getAlias = function () {
        if (!this._alias) {
            ...
            var target = this;
            while (target.parent && !(target.parent instanceof ProjectReflection_1.ProjectReflection) && !target.hasOwnDocument) {
