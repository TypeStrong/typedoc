...
var SourceDirectory_1 = require("../SourceDirectory");
...
var ProjectReflection = (function (_super) {
    ...
    function ProjectReflection(name) {
        _super.call(this, null, name, Reflection_1.ReflectionKind.Global);
        this.reflections = {};
        this.symbolMapping = {};
        this.directory = new SourceDirectory_1.SourceDirectory();
        this.files = [];
    }
