...
var MarkedPlugin = (function (_super) {
    ...
    function MarkedPlugin(renderer) {
        ...
        Handlebars.registerHelper('ifSignature', function (obj, arg) { return obj instanceof SignatureReflection_1.SignatureReflection ? arg.fn(this) : arg.inverse(this); });
        Marked.setOptions({
    ...
    MarkedPlugin.prototype.parseMarkdown = function (text, context) {
        ...
        var event = new MarkdownEvent_1.MarkdownEvent(MarkedPlugin.EVENT_PARSE_MARKDOWN);
