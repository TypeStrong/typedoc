...
var node_1 = require("./converters/node");
var type_1 = require("./converters/type");
var type_parameter_1 = require("./converters/factories/type-parameter");
...
var Context = (function () {
    ...
    Context.prototype.inherit = function (baseNode, typeArguments) {
        ...
        if (typeArguments) {
            this.typeArguments = typeArguments.map(function (t) { return type_1.convertType(_this, t); });
        }
        else {
            this.typeArguments = null;
        }
        node_1.convertNode(this, baseNode);
