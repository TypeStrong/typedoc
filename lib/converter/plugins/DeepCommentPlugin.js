...
var DeepCommentPlugin = (function (_super) {
    ...
    DeepCommentPlugin.prototype.onBeginResolve = function (context) {
        ...
        function push(parent) {
            ...
            if (!part || part.substr(0, 2) == '__' || parent instanceof SignatureReflection_1.SignatureReflection) {
                part = '';
            }
            if (part && part != '') {
        ...
        function findDeepComment(reflection) {
            ...
            while (target && !(target instanceof ProjectReflection_1.ProjectReflection)) {
                push(target);
                if (target.comment) {
                    var tag;
                    if (reflection instanceof TypeParameterReflection_1.TypeParameterReflection) {
