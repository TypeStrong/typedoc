...
//             Assert(
//                 !expanded.includes(Path.join(inputFiles, "class", "class.ts"))
//             );
//             Assert(
//                 !expanded.includes(Path.join(inputFiles, "access", "access.ts"))
//             );
//             Assert(!expanded.includes(inputFiles));
//         });
//         it("supports array of excludes", function () {
//             const inputFiles = Path.join(__dirname, "converter");
//             application.options.setValue("exclude", [
//                 "**/class.ts",
//                 "**/access.ts",
//             ]);
//             const expanded = application.expandInputFiles([inputFiles]);
...
//             Assert(
//                 !expanded.includes(Path.join(inputFiles, ".dot", "index.ts"))
//             );
//             Assert(!expanded.includes(inputFiles));
//         });
...
//                     Path.resolve(__dirname, "module", "a.ts").replace(
//                         /\\/g,
//                         "/"
//                     ),
//                 ]);
...
//             );
//             Assert.strictEqual(
//                 expanded.includes(Path.join(inputFiles, "alias", "alias.ts")),
//                 false
//             );
